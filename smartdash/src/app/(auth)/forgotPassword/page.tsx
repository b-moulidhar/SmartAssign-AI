  ...
  <div className="p-4 sm:p-7">
    <div className="text-center">
      ...
      <p className="mt-2 text-sm text-gray-600">
        ...
        <a className="text-blue-600 decoration-2 hover:underline hover:cursor-pointer focus:outline-hidden focus:underline font-medium" onClick={() => router.push('/login')}>
          Sign in here
        </a>
      </p>
    </div>
